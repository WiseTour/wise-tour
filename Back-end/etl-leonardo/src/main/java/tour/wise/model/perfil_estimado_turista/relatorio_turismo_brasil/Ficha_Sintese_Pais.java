...
public class Ficha_Sintese_Pais extends Ficha_Sintese_Brasil {
    ...
    public Ficha_Sintese_Pais(Integer ano, List<Motivo_Viagem> motivos, List<Composicao_Grupo_Viagem> composicao_grupos_viagem, List<Gasto_Medio_Per_Capita_Brasil_Motivo> gastos_medio_per_capita_brasil_motivo, List<Destinos_Mais_Visistados_Por_Motivo> destinos_mais_visistados_por_motivo, List<Fonte_Informacao> fontes_informacao, List<Utilizacao_Agencia_Viagem> utilizacao_agencia_viagem, String pais) {
